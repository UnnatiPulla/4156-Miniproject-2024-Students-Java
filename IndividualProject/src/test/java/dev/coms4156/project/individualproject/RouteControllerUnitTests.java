...
public class RouteControllerUnitTests {
  ...
  public void retrieveDepartmentTest() {
    ...
    // We know the expected response from IndividualProjectApplication.java's resetDataFile() method
    // which received its setup data from data.txt
    String deptCode = "ECON";
    String expectedResponse = "ECON 1105: \n"
  ...
  public void getMajorCountFromDeptTest() {
    // We know from the data provided to us that the dept "IEOR" has 67 majors (students) in it.
  ...
  public void idDeptChairTest() {
    // We know from the data provided to us that the dept "COMS" has "Luca Carloni" as dept chair.
  ...
  public void findCourseLocationTest() {
    ...
    ResponseEntity<?> response = routeController.findCourseLocation("IEOR",
        4540);
    assertEquals(200, response.getStatusCode().value());
    assertEquals(expectedResponse, response.getBody());
  }
  ...
  public void findCourseInstructorTest() {
    // We know from the data provided to us that ieor4540's instructor is Krzysztof M Choromanski
  ...
  public void addMajorToDeptTest() {
    ...
    // Hence we should be able to successfully add a major to it and return 200 http code response.
  ...
  public void changeCourseTimeTest() {
    ...
    String expectedResponse = "Attributed was updated successfully.";
    ResponseEntity<?> response = routeController.changeCourseTime("IEOR",
        4511, "7:10-9:40");
    assertEquals(200, response.getStatusCode().value());
    assertEquals(expectedResponse, response.getBody());
  }
  ...
  public void changeCourseTeacherTest() {
    ...
    String expectedResponse = "Attributed was updated successfully.";
    ResponseEntity<?> response = routeController.changeCourseTeacher("ELEN",
        1201, "Kenneth Shepard");
    assertEquals(200, response.getStatusCode().value());
    assertEquals(expectedResponse, response.getBody());
  }
  ...
  public void changeCourseLocationTest() {
    ...
    String expectedResponse = "Attributed was updated successfully.";
    ResponseEntity<?> response = routeController.changeCourseLocation("ELEN",
        1201, "1205 MUDD");
    assertEquals(200, response.getStatusCode().value());
    assertEquals(expectedResponse, response.getBody());
  }
